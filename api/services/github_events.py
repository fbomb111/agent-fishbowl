...
ACTOR_MAP: dict[str, str] = {
    ...
    "fishbowl-ops-engineer[bot]": "ops-engineer",
    "fishbowl-reviewer[bot]": "reviewer",
    "fishbowl-product-owner[bot]": "product-owner",
    "fishbowl-product-manager[bot]": "product-manager",
    "fishbowl-tech-lead[bot]": "tech-lead",
    "fishbowl-user-experience[bot]": "user-experience",
    "fishbowl-triage[bot]": "triage",
    "fishbowl-site-reliability[bot]": "site-reliability",
    "fishbowl-content-creator[bot]": "content-creator",
    "fishbowl-infra-engineer[bot]": "ops-engineer",
    "fishbowl-qa-analyst[bot]": "qa-analyst",
    "fishbowl-customer-ops[bot]": "customer-ops",
    "fishbowl-escalation-lead[bot]": "escalation-lead",
    "fishbowl-financial-analyst[bot]": "financial-analyst",
    "fishbowl-human-ops[bot]": "human-ops",
    "fishbowl-marketing-strategist[bot]": "marketing-strategist",
    "fishbowl-product-analyst[bot]": "product-analyst",
